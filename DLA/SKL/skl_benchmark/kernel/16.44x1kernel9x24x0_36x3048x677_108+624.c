...
#define L1_DIST_A 108
#define L1_DIST_B 624

void micro_kernel0(int k, const double * A, const double * B, double * C, int ncol)
{
  int i;
  register __m512d _B0, _B1, _B2;
  register __m512d _C0_0, _C0_1, _C0_2, _C0_3, _C0_4, _C0_5, _C0_6, _C0_7, _C0_8;
  register __m512d _C1_0, _C1_1, _C1_2, _C1_3, _C1_4, _C1_5, _C1_6, _C1_7, _C1_8;
  register __m512d _C2_0, _C2_1, _C2_2, _C2_3, _C2_4, _C2_5, _C2_6, _C2_7, _C2_8;
    ...
    _C1_7 = _mm512_loadu_pd(&C[7*ncol+8]);
    _C2_7 = _mm512_loadu_pd(&C[7*ncol+16]);
    _C0_8 = _mm512_loadu_pd(&C[8*ncol+0]);
    _C1_8 = _mm512_loadu_pd(&C[8*ncol+8]);
    _C2_8 = _mm512_loadu_pd(&C[8*ncol+16]);
  // _C += A*B
  for(i=0; i<k ; i++)
  {
    // A L1 prefetch
    ...
    _C1_7 = _mm512_fmadd_pd(_mm512_set1_pd(A[7]), _B1, _C1_7);
    _C2_7 = _mm512_fmadd_pd(_mm512_set1_pd(A[7]), _B2, _C2_7);
    _C0_8 = _mm512_fmadd_pd(_mm512_set1_pd(A[8]), _B0, _C0_8);
    _C1_8 = _mm512_fmadd_pd(_mm512_set1_pd(A[8]), _B1, _C1_8);
    _C2_8 = _mm512_fmadd_pd(_mm512_set1_pd(A[8]), _B2, _C2_8);
    A += MR;
    B += NR;
  }
  // store _C -> C
  ...
  _mm512_storeu_pd(&C[7*ncol+8], _C1_7);
  _mm512_storeu_pd(&C[7*ncol+16], _C2_7);
  _mm512_storeu_pd(&C[8*ncol+0], _C0_8);
  _mm512_storeu_pd(&C[8*ncol+8], _C1_8);
  _mm512_storeu_pd(&C[8*ncol+16], _C2_8);
}
void micro_kernel1(int k, const double * A, const double * B, double * C, int ncol)
{
  ...
  register __m512d _C2_0, _C2_1, _C2_2, _C2_3, _C2_4, _C2_5, _C2_6, _C2_7, _C2_8;
    ...
    _C1_7 = _mm512_setzero_pd();
    _C2_7 = _mm512_setzero_pd();
    _C0_8 = _mm512_setzero_pd();
    _C1_8 = _mm512_setzero_pd();
    _C2_8 = _mm512_setzero_pd();
  // _C += A*B
  for(i=0; i<k ; i++)
  {
    // A L1 prefetch
