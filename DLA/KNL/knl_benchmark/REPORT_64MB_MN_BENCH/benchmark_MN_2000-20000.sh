...
for((i=2000;i<=20000;i+=2000));do
	...
	make validKernel KERNEL=${kernel} M=${i} N=${i} K=5000 STACK=64 NT=${nPack} NT1=${ni} NT2=${njr} 
	make flopsKernel KERNEL=${kernel} M=${i} N=${i} K=5000 STACK=64 NT=${nPack} NT1=${ni} NT2=${njr} 
	make executeValid KERNEL=${kernel} M=${i} N=${i} K=5000 STACK=64 NT=${nPack} NT1=${ni} NT2=${njr} 
	make executeFlops KERNEL=${kernel} M=${i} N=${i} K=5000 STACK=64 NT=${nPack} NT1=${ni} NT2=${njr} 
	sleep 2
	make executeFlops KERNEL=${kernel} M=${i} N=${i} K=5000 STACK=64 NT=${nPack} NT1=${ni} NT2=${njr} 
	sleep 2
	make executeFlops KERNEL=${kernel} M=${i} N=${i} K=5000 STACK=64 NT=${nPack} NT1=${ni} NT2=${njr} 
