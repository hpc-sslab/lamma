...
#define L1_DIST_A 300
#define L1_DIST_B 320

void micro_kernel0(int k, const double * A, const double * B, double * C, int ncol)
{
  int i;
  register __m512d _B0, _B1;
  register __m512d _C0_0, _C0_1, _C0_2, _C0_3, _C0_4, _C0_5, _C0_6, _C0_7, _C0_8, _C0_9, _C0_10, _C0_11, _C0_12, _C0_13, _C0_14;
  register __m512d _C1_0, _C1_1, _C1_2, _C1_3, _C1_4, _C1_5, _C1_6, _C1_7, _C1_8, _C1_9, _C1_10, _C1_11, _C1_12, _C1_13, _C1_14;
    ...
    _C1_9 = _mm512_loadu_pd(&C[9*ncol+8]);
    _C0_10 = _mm512_loadu_pd(&C[10*ncol+0]);
    _C1_10 = _mm512_loadu_pd(&C[10*ncol+8]);
    _C0_11 = _mm512_loadu_pd(&C[11*ncol+0]);
    _C1_11 = _mm512_loadu_pd(&C[11*ncol+8]);
    _C0_12 = _mm512_loadu_pd(&C[12*ncol+0]);
    _C1_12 = _mm512_loadu_pd(&C[12*ncol+8]);
    _C0_13 = _mm512_loadu_pd(&C[13*ncol+0]);
    _C1_13 = _mm512_loadu_pd(&C[13*ncol+8]);
    _C0_14 = _mm512_loadu_pd(&C[14*ncol+0]);
    _C1_14 = _mm512_loadu_pd(&C[14*ncol+8]);
  // _C += A*B
  for(i=0; i<k ; i++)
  {
    // A L1 prefetch
    ...
    _C1_9 = _mm512_fmadd_pd(_mm512_set1_pd(A[9]), _B1, _C1_9);
    _C0_10 = _mm512_fmadd_pd(_mm512_set1_pd(A[10]), _B0, _C0_10);
    _C1_10 = _mm512_fmadd_pd(_mm512_set1_pd(A[10]), _B1, _C1_10);
    _C0_11 = _mm512_fmadd_pd(_mm512_set1_pd(A[11]), _B0, _C0_11);
    _C1_11 = _mm512_fmadd_pd(_mm512_set1_pd(A[11]), _B1, _C1_11);
    _C0_12 = _mm512_fmadd_pd(_mm512_set1_pd(A[12]), _B0, _C0_12);
    _C1_12 = _mm512_fmadd_pd(_mm512_set1_pd(A[12]), _B1, _C1_12);
    _C0_13 = _mm512_fmadd_pd(_mm512_set1_pd(A[13]), _B0, _C0_13);
    _C1_13 = _mm512_fmadd_pd(_mm512_set1_pd(A[13]), _B1, _C1_13);
    _C0_14 = _mm512_fmadd_pd(_mm512_set1_pd(A[14]), _B0, _C0_14);
    _C1_14 = _mm512_fmadd_pd(_mm512_set1_pd(A[14]), _B1, _C1_14);
    A += MR;
    B += NR;
  }
  // store _C -> C
  ...
  _mm512_storeu_pd(&C[9*ncol+8], _C1_9);
  _mm512_storeu_pd(&C[10*ncol+0], _C0_10);
  _mm512_storeu_pd(&C[10*ncol+8], _C1_10);
  _mm512_storeu_pd(&C[11*ncol+0], _C0_11);
  _mm512_storeu_pd(&C[11*ncol+8], _C1_11);
  _mm512_storeu_pd(&C[12*ncol+0], _C0_12);
  _mm512_storeu_pd(&C[12*ncol+8], _C1_12);
  _mm512_storeu_pd(&C[13*ncol+0], _C0_13);
  _mm512_storeu_pd(&C[13*ncol+8], _C1_13);
  _mm512_storeu_pd(&C[14*ncol+0], _C0_14);
  _mm512_storeu_pd(&C[14*ncol+8], _C1_14);
}
void micro_kernel1(int k, const double * A, const double * B, double * C, int ncol)
{
  ...
  register __m512d _C1_0, _C1_1, _C1_2, _C1_3, _C1_4, _C1_5, _C1_6, _C1_7, _C1_8, _C1_9, _C1_10, _C1_11, _C1_12, _C1_13, _C1_14;
    ...
    _C1_9 = _mm512_setzero_pd();
    _C0_10 = _mm512_setzero_pd();
    _C1_10 = _mm512_setzero_pd();
    _C0_11 = _mm512_setzero_pd();
    _C1_11 = _mm512_setzero_pd();
    _C0_12 = _mm512_setzero_pd();
    _C1_12 = _mm512_setzero_pd();
    _C0_13 = _mm512_setzero_pd();
    _C1_13 = _mm512_setzero_pd();
    _C0_14 = _mm512_setzero_pd();
    _C1_14 = _mm512_setzero_pd();
  // _C += A*B
  for(i=0; i<k ; i++)
  {
    // A L1 prefetch
